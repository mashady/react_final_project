const en = {
  ...
  verificationDocumentTypeError: "Unsupported file format (only JPG, PNG, PDF, JPEG)",
  ...
  emailAlreadySentDescription: "A verification email has already been sent to this address. Please check your inbox.",
  goToLogin: "Go to Login",

  emailAlreadyVerified: "Email Already Verified",
  emailAlreadyVerifiedDescription: "This email address has already been verified. You can now log in.",
  
  verificationFailed: "Verification Failed!",
  verificationFailedDescription: "The verification link is invalid or has expired. Please request a new verification email.",
  goToResendVerifyMail: "Go to Resend Verification Mail",
  resendVerifyMail: "Resend Verification Email",
  resendVerifyMailDescription: "Please enter your email address to receive a new verification email.",
  verificationEmailSent: "Verification email has been sent successfully!",
  resending: "Resending...",
  emailAlreadyVerified: "Email already verified",
  verifyEmailSent: "Email Has Been Sent",
  verifyEmailSentDescription: "A verification email has been sent to this address. Please check your inbox.",
  emailVerified: "Email Verified!",
  emailVerifiedDescription: "Your email has been successfully verified. You can now log in and enjoy full access.",
