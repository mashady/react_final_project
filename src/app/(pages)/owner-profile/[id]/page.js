...
const OwnerProfilePage = () => {
    ...
    return ( <
        ...
        className = "my-6 space-y-3 w-full" > {
            user ? ( <
                >
                <
                ...
                div className = "flex justify-between border-b-1 border-gray-200 py-2" >
                <
                p className = "text-gray-600" > { t("ownerProfileWhatsapp") }:
                <
                /p> <
        ...
        <
        article id = "ownerProperties"
        className = "w-full bg-white px-5 border-b-1 border-gray-200 py-3 rounded-sm mt-5" >
        <
        h3 className = "text-3xl font-medium mb-8" > { t("ownerProfileListing") } <
        /h3> <
        ...
        style = {
            { fontWeight: 500 } } > { t("ownerReviews") } <
        /h3> <
        OwnerReviewList ownerId = { id }
